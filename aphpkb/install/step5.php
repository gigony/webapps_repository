...
$default_pluginmaa = stripslashes($_POST['install_pluginmaa']);  
...
define ('PLUGINMAA' , '$default_pluginmaa');
...
PLUGINMAA = $default_pluginmaa<br />
...
<input type="hidden" name="install_pluginmaa" value="<?php echo $default_pluginmaa;?>" />
