...
$default_pluginmaa = $_POST['install_pluginmaa'];  
...
<input type="checkbox" name="install_pluginrss" value="1" <?php if($default_pluginrss=='1') {echo 'checked';}?> /> RSS Plugin<br />
<input type="checkbox" name="install_pluginmaa" value="1" <?php if($default_pluginmaa=='1') {echo 'checked';}?> /> Multi-Authored Articles Plugin<br /></p>
