...
$query="UPDATE articles SET Title='$titlee', Articledata='$articledatae', Keyw='$keywordse' WHERE FileID='$fileid'";
...
$query2 = "SELECT Title, AuthorID, Approved, Keyw, Articledata from articles WHERE FileID='$fileid' LIMIT 1";
