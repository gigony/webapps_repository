<?php
 ...
 if($_POST["addclass"] == 1 && $_POST["title"] != "" && $_POST["teacher"] != "" && $_POST["semester"] != "" && $_POST["roomnum"] != "" && $_POST["periodnum"] != "")
 {
  ...
  else
  {
   ...
   $query = mysql_query("INSERT INTO courses (semesterid, courseid, teacherid, sectionnum, roomnum, periodnum, dotw, subtituteid) VALUES( '$_POST[semester2]', '$termid', '$_POST[title]', '$_POST[teacher]', '$_POST[sectionnum]', '$_POST[roomnum]', '$_POST[periodnum]','$dotw','$_POST[substitute]')")
	or die("ManageClasses.php: Unable to insert new class - " . mysql_error());
