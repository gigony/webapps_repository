<?php
 ...
 if($_POST['editgrade'] == 1)
 {
  ...
  else
  {
   ...
   $query = mysql_query("INSERT INTO grades (assignmentid, courseid, semesterid, termid, studentid, points, comment, submitdate, islate) VALUES( '$_POST[assignment]', '$_POST[selectclass]', '$ids[0]', '$ids[1]', '$_POST[student]', '$_POST[points]', '$_POST[comment]', '".converttodb($_POST['gradedate'])."', '".($_POST['late']==1 ? "1" : "0")."')")
