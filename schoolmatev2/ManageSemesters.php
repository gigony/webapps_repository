<?php
 ...
 if($_POST["addsemester"] == 1 && $_POST["term"] != "" && $_POST["title"] != "" && $_POST["startdate"] != "" && $_POST["middate"] != "" && $_POST["enddate"] != "")
 {
  ...
  $query = mysql_query("INSERT INTO semesters (termid,title,startdate,midtermdate,enddate,type) VALUES( $_POST[term], '$_POST[title]', '$_POST[startdate]', '$_POST[middate]', '$_POST[enddate]', '$_POST[half]')")
