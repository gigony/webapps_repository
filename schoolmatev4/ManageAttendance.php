<?php
 ...
 if($_POST["addattendance"] == 1)
 {
  ...
  $query = mysql_query("INSERT INTO schoolattendance (studentid, sattenddate, semesterid, termid, type) VALUES( '$_POST[student]', '".converttodb($_POST["attdate"])."', '$_POST[semester]', $id, '$_POST[type]')")
